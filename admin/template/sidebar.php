              ...
              <ul class="sidebar-menu" id="nav-accordion">
				  ...
				  <li class="sub-menu">
                      ...
                      <ul class="sub">
						  ...
						  <li><a  href="index.php?page=laporan">Laporan Keseluruhan</a></li>
						  <li><a  href="index.php?page=l_bulan">Berdasarkan Bulan</a></li>
						  <li><a  href="index.php?page=l_tahun">Berdasarkan Tahun</a></li>
   						  <li><a  href="index.php?page=l_pel">Berdasarkan Pelanggan</a></li>
