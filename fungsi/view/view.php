		...
		function __construct($db){
			...
			function jual(){
				$sql ="SELECT penjualan.* , barang.id_barang, barang.nama_barang, member.id_member,
						member.nm_member, pelanggan.kd_pel, pelanggan.nm_pel from penjualan 
					   left join barang on barang.id_barang=penjualan.id_barang 
					   left join member on member.id_member=penjualan.id_member
					   left join pelanggan on pelanggan.kd_pel=penjualan.kd_pel
			...
			function pelanggan_edit($id){	
				$sql = "select*from pelanggan where kd_pel=?";
				$row = $this-> db -> prepare($sql);
				$row -> execute(array($id));
				$hasil = $row -> fetch();
				return $hasil;
